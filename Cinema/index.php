...
<div class="row">
            ...
            <form action="" method="POST">
                <input placeholder="Ime" name="fName" required><br>
                <input placeholder="Prezime" name="lName" ><br>
                <input placeholder="E-mail " name="eMail" required><br>
                <textarea placeholder="Upiši svoju poruku !" name="feedback" rows="3" cols="30" required></textarea><br>
                <button type="submit" name="submit" value="submit">Pošalji svoju poruku</button>
                <?php
                 $link = mysqli_connect("localhost", "root", "", "baza");
